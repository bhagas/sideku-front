...
<template>
    ...
    <div id="GejalaFisik">
            ...
            <b-row>
                <b-col md="12" style="margin-top:60px;margin-bottom:60px;">
                    <div class="box">
                        <b-row>
                            <b-col md="12">
                                <h3 class="text-center m-t-0 m-b-0"><strong>DATA MASTER GEJALA FISIK</strong></h3>
                            </b-col>
                        </b-row>
                        ...
                        <b-row class="m-t-15">
                            <b-col md="12">
                                <b-breadcrumb>
                                    ...
                                    <b-breadcrumb-item active>Data Master Gejala Fisik</b-breadcrumb-item>
                                </b-breadcrumb>
                            </b-col>
                        </b-row>
        ...
        <b-modal id="modal-1" hide-footer centered title="TAMBAH DATA MASTER GEJALA FISIK">
            <b-form class="bv-example-row">
                <b-form-group 
                label="Gejala Fisik" 
                >
...
export default {
    ...
    data() {
      return {
        ...
        fields: [
          { key: 'namaGejalaFisik', label: 'Gejala Fisik', sortable: true, sortDirection: 'desc' },
    ...
    methods: {
      info(item, index, button) {
        this.infoModal.title = `EDIT DATA MASTER GEJALA FISIK`
        this.infoModal.content = item
        // console.log(item)
        // console.log( item.namaPenyakit)
        //keluarkan model sesuai id
        this.idChoose = item.id
        this.gejalaFisikEdit = item.namaGejalaFisik
      ...
      tambah(){
             let vm = this;
           axios.post('http://sideku.org:8801/gejalaFisik/register', {
                 namaGejalaFisik: this.gejalaFisik
        ...
        edit(){
            let vm = this;
           axios.patch('http://sideku.org:8801/gejalaFisik/'+this.idChoose, {
                 namaGejalaFisik: this.gejalaFisikEdit
              ...
              .then(function (response) {
                ...
                // console.log(idx)
                vm.items[idx].namaGejalaFisik = vm.gejalaFisikEdit
           ...
           hapus(id){
                let vm = this;
           axios.delete('http://sideku.org:8801/gejalaFisik/delete/'+id,{
              headers: {
                      'accesstoken': localStorage.getItem('token')
                  }
            })
